/* ============================================================
   IIMS Role Script — WATER (Bottled & Packaged Water Manufacturer)
   Injected into every page inside /main/water/
   ============================================================ */
(function () {
  'use strict';
  ...
  var ROLE = {
    id: 'water',
    name: 'Water Manufacturer',
    subtitle: 'Registered Bottled Water Entity',
    badge: 'WATER',
    color: '#14B8A6',
    colorLight: '#F0FDFA',
    nav: [
  ...
  function buildNav() {
    var cur = window.location.pathname.split('/').pop() || 'iims-water-registration-form.html';
