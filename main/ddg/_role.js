/* ============================================================
   IIMS Role Script â€” Deputy Director General (DDG)
   Injected into every page inside /main/ddg/
   ============================================================ */
(function () {
  'use strict';
  ...
  var ROLE = {
    id: 'ddg',
    name: 'Deputy Director General (DDG)',
    subtitle: 'Environmental & Occupational Health',
    badge: 'DDG',
    color: '#BE185D',
    nav: [
      { type: 'cap', label: 'Home' },
